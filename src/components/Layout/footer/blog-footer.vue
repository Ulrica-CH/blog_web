<template>
  ...
  <div class="footer_box flex flex-col items-center justify-center">
    <div class="footer-color">&copy MichstaBe 2023</div>
    <a
      class="footer-color change-color mt-[5px]"
      href="http://beian.miit.gov.cn/"
      target="_blank"
    ></a>
    <div class="footer-color mt-[5px] flex justify-center flex-wrap">
      <a class="p-[3px]" href="https://cn.vuejs.org/" target="_blank">
        <img
          src="https://img.shields.io/badge/vue-%E5%89%8D%E7%AB%AF%E6%A1%86%E6%9E%B6-vue%203"
          alt=""
        />
      </a>
      <a class="p-[3px]" href="http://koajs.com.cn/" target="_blank">
        <img
          src="https://img.shields.io/badge/Koa-%E5%90%8E%E7%AB%AF%E6%A1%86%E6%9E%B6-%20%23ccc"
          alt=""
        />
      </a>
      <a
      ...
      <a
        class="p-[3px]"
        href="https://imzbf.github.io/md-editor-v3/docs/index"
        target="_blank"
      >
        <img
